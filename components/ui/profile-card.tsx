...
export function ProfileCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative h-96 w-full max-w-80 rounded-3xl border border-border/20 text-card-foreground overflow-hidden shadow-xl shadow-black/5 cursor-pointer group backdrop-blur-sm",
